    ...
    <aside class="w-52 border-r min-h-full  flex flex-col items-center gap-16 ">
        ...
        <div class="">
            <div class="grid gap-4 w-[100%]">
                ...
                <a href='staff.php' class='flex gap-4 px-4 py-2 rounded-2xl'><img src='./img/3 User.svg' alt=''> Clients </a>
                <a href='apprenant.php' class='flex gap-4 px-4 py-2 rounded-2xl'><img id='btn-icon' class='mt-1' src='./img/3 User.svg' alt=''> Activities</a>
            
               
                <a href="#" class="flex gap-4 px-4 py-2 rounded-2xl"><img src="./img/Settings_Future.svg" alt=""> Reservations </a>
            </div>
        </div>
    </aside>
    <div class="grow">
